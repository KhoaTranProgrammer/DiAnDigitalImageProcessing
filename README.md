![picture](https://github.com/KhoaTranProgrammer/DiAnDigitalImageProcessing/blob/DigitalImageProcessingInQt/app/DigitalImageProcessingInQt/cover.png)
...
- `source`: source files that implement DADIP library
- `res`: image files
